                  ...
                  <div id="login_div">                    
                    <ValidationObserver v-slot="{ handleSubmit }">
                      <form @submit.prevent="handleSubmit(resetConfirm)">
                         <h6 class="mr-2 mt-4">New Password</h6>
                        ...
                        <h6 class="mr-2 mt-4">Confirmation New Password</h6>   
                        ...
                        <div class="vx-row no-gutter justify-center items-center">
                          <button class="w-full mt-6 button-submit" type="submit">Change Password</button>
                        </div>
                      </form>
                    </ValidationObserver>                  
                  </div>
...
export default {
  ...
  methods: {
    ...
    resetConfirm () {
        ...
        console.log(payload);
        axios.post('/api/create_new_password',payload).then(response => {
